...
function getAllStyles (){
    ...
    //wp_enqueue_style('sweetAlertsCss', 'https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css', array(),'1.12','all');
...
function getAllScripts(){
    ...
    //wp_enqueue_script('sweetAlerts','https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert-dev.min.js',array(),'1.0.0',true);
