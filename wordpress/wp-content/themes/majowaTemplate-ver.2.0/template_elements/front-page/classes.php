    ...
    <div class="classes-container" id="zajecia">
        <div class="classes-box">
            <div class="single-class solo-class">
                <img src="<?php echo get_template_directory_uri() ?>/img/solo.png">
        ...
        <div class="classes-box">
            <div class="single-class ">
                <img src="<?php echo get_template_directory_uri() ?>/img/dla_zdrowia.png">
        ...
        <div class="classes-box">
            <div class="single-class">
                <img src="<?php echo get_template_directory_uri() ?>/img/wparze.png">
